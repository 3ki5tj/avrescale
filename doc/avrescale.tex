...
\begin{center}
  ...
  \caption{
    ...
    %
    The thicker curves are the analytical predictions from
    ...
    %
    The thinner curves were from the more approximate theory
    that assumes the fluctuation is a white noise,
    and this assumption is less reliable for shorter simulations
    (cf. Appendix \ref{sec:whitenoise}).
    %
...
is the $1/t$ prescription. %, which results from runtime averaging.
%
...
can be measured as the expectation of $x^2(T)$,
%
\begin{align}
  \left\langle
    x^2(T)
...
as shown in Fig. \ref{fig:errz}.
%
Under this assumption the error functional, Eq. \eqref{eq:err_functional},
is simplified as
%
\begin{equation}
  \left\langle
