...
plot [:1000][-6160:-6000] \
    "../../data/wb/trace/set2/etot_AVS.tr"      u ($1):($2) every 20 w  p  pt 7  ps 1.2 notitle, \
    ...
    "../../data/wb/trace/set2/etot_NHCP100.tr"  u ($1):($2) w l   lt 4              notitle, \
    "../../data/wb/trace/set2/etot_VRSDt100.tr" u ($1):($2) w l   lt 3              notitle, \
    ...
    0                                                       w lp  lt 4 pt 12 ps 1.2 t "Nos\351-Hoover chain", \
    0                                                       w lp  lt 3 pt 10 ps 1.2 t "Velocity rescaling, {/Symbol-Oblique t} = 0.1 ps", \
